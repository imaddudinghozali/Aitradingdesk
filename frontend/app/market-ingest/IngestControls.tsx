    ...
    <div className="space-y-3 text-xs">
      <div className="flex flex-wrap gap-2">
        <button
          ...
          disabled={pending}
          onClick={() => call("/market/ingest/run", {})}
        >
          Run once
        </button>
        <button
          className="rounded border border-shadow-border bg-shadow-bg px-3 py-1.5 hover:border-shadow-accent disabled:opacity-50"
          disabled={pending}
          onClick={() => call("/market/ingest/scheduler/start", {})}
        >
          Start scheduler
        </button>
        <button
          className="rounded border border-shadow-border bg-shadow-bg px-3 py-1.5 hover:border-shadow-accent disabled:opacity-50"
          disabled={pending}
          onClick={() => call("/market/ingest/scheduler/stop", {})}
        >
          Stop scheduler
        </button>
      </div>
      ...
      <p className="text-shadow-muted">
        Defaults come from{" "}
        <span className="font-mono text-shadow-ink">MARKET_DATA_PROVIDER</span>,{" "}
        <span className="font-mono text-shadow-ink">MARKET_INGEST_SYMBOLS</span>,{" "}
        <span className="font-mono text-shadow-ink">MARKET_INGEST_TIMEFRAMES</span>,{" "}
        and{" "}
        <span className="font-mono text-shadow-ink">
          MARKET_INGEST_INTERVAL_SECONDS
        </span>{" "}
        in the backend .env.
      </p>
    </div>
